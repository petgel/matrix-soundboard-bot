...
export class RustCrypto extends TypedEventEmitter {
  ...
  onUserIdentityUpdated(userId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this62.emit(CryptoEvent.UserTrustStatusChanged, userId.toString(), newVerification);
      ...
      if (userId.toString() === _this62.userId) {
        _this62.emit(CryptoEvent.KeysChanged, {});
  ...
  onDevicesUpdated(userIds) {
    var _this63 = this;
    return _asyncToGenerator(function* () {
      _this63.emit(CryptoEvent.WillUpdateDevices, userIds, false);
      _this63.emit(CryptoEvent.DevicesUpdated, userIds, false);
    })();
  }
  ...
  getOwnIdentity() {
    var _this68 = this;
    return _asyncToGenerator(function* () {
      return yield _this68.olmMachine.getIdentity(new RustSdkCryptoJs.UserId(_this68.userId));
    })();
  }
}
class EventDecryptor {
  ...
  attemptEventDecryption(event, isolationMode) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        var res = yield _this69.olmMachine.decryptRoomEvent(stringifyEvent(event), new RustSdkCryptoJs.RoomId(event.getRoomId()), new RustSdkCryptoJs.DecryptionSettings(trustRequirement));
  ...
  getEncryptionInfoForEvent(event) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var encryptionInfo = yield _this70.olmMachine.getRoomEventEncryptionInfo(stringifyEvent(event), new RustSdkCryptoJs.RoomId(event.getRoomId()));
